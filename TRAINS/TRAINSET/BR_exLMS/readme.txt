...
This zip file contains texture files that are common to all of the Blood and Custard ex-LMS coaches.  They MUST be installed before any of the coaches will work.
...
3 - Create a folder in the 'TrainSet' folder called 'BR_exLMS'.


4 - Navigate to the folder called 'BR_exLMS'.  Copy all of the files from the zip file into this folder.