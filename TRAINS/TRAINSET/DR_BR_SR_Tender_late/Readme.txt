BR Class5 4-6-0 steam locomotive

3D Model built from drawings and textured by Dave Robinson
Cab view by Clive Heard (casperdog)
...
This is a model of a BR Class5 4-6-0 73082 Camelot
In BR Black Livery

This loco comes with changeable headlamps and disk simple copy over all the dead lamps or disks first from the dead lamp 
folder in to the main folder and then copy from the live lamps folder the lamps or disks you require on the loco to the 
main folder.
The cabview is supplied with thanks from Clive Heard and you must have Stuart Williamson 2Cyl sounds File ID 2910 on 
Uktrainsim for the sounds to work
